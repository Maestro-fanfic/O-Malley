...
""",
        "stories": {
            "dana": {
                ...
                "status": "complete",
                "status_label": "Complete (16 chapters)",
                "mode": "dir",
    ...
    "jumper": {
        ...
        "home_blurb": "Set after Exo, following the same multi-POV first-person structure the source novels use.",
        "intro_html": """
...
<p>Follows Cent, Millie, and Davy as jumping stops being anyone's private secret. A light crossover element runs through the series: characters from <em>The Core</em>, <em>Armageddon</em>, and a book by Drew Goddard. Deliberately kept vague.</p>
""",
        ...
        "stories": {
            "momentum": {
                ...
                "blurb": "Cent's post-Exo life on Kristen Station is steady, hard-won, almost boring, the good kind. Normal doesn't last. She has to find out what all that stability was for.",
                "status": "complete",
            ...
            "reach": {
                ...
                "blurb": "The direct follow-up to Momentum: further out, and a crew that just keeps growing.",
                "status": "complete",
            ...
            "contact": {
                ...
                "fandom": "Jumper (Steven Gould)",
                "blurb": "The trilogy's capstone. A routine orbital cleanup job turns into something even eleven thousand people can't handle.",
                "status": "complete",
